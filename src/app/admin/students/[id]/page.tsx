...
export default function EditStudentPage() {
    ...
    const [originalData, setOriginalData] = useState<any>(null) // Store original data for comparison
        ...
        const fetchStudent = async () => {
            ...
            try {
                ...
                if (data) {
                    ...
                    if (data) return formattedData // Helper to return data if needed, but we set state above)
                }
            } catch (error: any) {
