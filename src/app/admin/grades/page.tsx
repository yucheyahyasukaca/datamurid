...
export default function AdminGradesMenuPage() {
    ...
    const gradeTypes = [
        ...
        },
        {
            ...
            description: 'Kelola data nilai PDSS siswa',
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 text-sm">
                        Pilih jenis nilai yang ingin dikelola
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
                {gradeTypes.map((type) => (
                    <button
                        key={type.id}
                        onClick={() => router.push(`/admin/grades/${type.id}`)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
                <div className="glass-panel p-6 rounded-xl border border-white/5">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h4 className="text-white font-semibold mb-1">Info TKA</h4>
                            <p className="text-slate-400 text-sm">
                                Data tes kemampuan akademik siswa
                            </p>
                        </div>
                    </div>
                </div>
